...
const results = [
  ...
  { title: "พบ Glucose", desc: "แนะนำตรวจซ้ำ", date: "18 ก.พ. 2569 · 14:30 น.", status: "ระวัง", color: "bg-warning" },
  ...
  { title: "พบทั้ง Glucose และ Microalbumin", desc: "แนะนำให้ปรึกษาเภสัชกร", date: "10 ม.ค. 2569 · 11:20 น.", status: "เสี่ยง", color: "bg-destructive" },
];
